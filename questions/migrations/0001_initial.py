# Generated by Django 2.1.2 on 2018-11-05 21:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.CharField(max_length=120, verbose_name='Ответ на вопрос')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='questions.User')),
            ],
            options={
                'ordering': ['-create_date'],
            },
            managers=[
                ('by_data', django.db.models.manager.Manager()),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
